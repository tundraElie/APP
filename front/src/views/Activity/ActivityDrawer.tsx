...
import language from '../../config/languageActivityDrawer';
...
const ActivityDrawer = ({ drawerWidth, children } : DrawerProps) => {
          ...
          return (
            ...
            >
              <ListItemButton
                selected={active}
              >
                <ListItemIcon sx={{ color: color.OnPrimary[0] }}>
                  {icon}
                </ListItemIcon>
                <ListItemText>
